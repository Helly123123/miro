<template>
  <div class="button-voice">
    ...
    <span class="title">Начать общение</span>
  </div>
</template>

<script setup>
// Анимация работает автоматически
</script>
...
.button-voice {
  ...
  position: relative;
  box-shadow: 0 10px 20px rgba(90, 184, 199, 0.3);
  transition: all 0.3s;
  gap: 20px;
  overflow: hidden;
}
...
.button-voice:hover {
  background-color: #4aa8b7;
  box-shadow: 0 15px 25px rgba(90, 184, 199, 0.4);
}
